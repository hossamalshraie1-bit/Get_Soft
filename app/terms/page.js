...
export const metadata = {
  title: 'شروط الاستخدام | جيت سوفت',
  description: 'شروط وأحكام استخدام موقع شركة جيت سوفت للبرمجيات وتصميم المواقع.',
    ...
    <>
      ...
      <main className="min-h-screen" style={{ paddingTop: '140px', paddingBottom: '80px' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <div className="card">
            <p className="mb-4">يرجى قراءة شروط الاستخدام هذه بعناية قبل تصفح أو استخدام الخدمات المقدمة عبر موقع جيت سوفت.</p>
            ...
            <p className="mb-4">جميع محتويات الموقع من نصوص، أكواد، تصميمات، وشعارات هي ملك لشركة جيت سوفت، ويُمنع نسخها أو إعادة استخدامها دون إذن كتابي مسبق.</p>
